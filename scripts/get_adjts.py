"""
Functions for fetching and storing data related to `CONTs` (contracts)
related to `ADJTs` (bidders) & `ADJT_Cs` (classified bidders)
from `www.contratación.euskadi.eus`

Useful resources:

    · Register of bidders and classified companies:
    https://www.contratacion.euskadi.eus/informacion-general-registro-licitadores-empresas-clasificadas/w32-kperoc/es/

    · Register of bidders and classified companies, search engine:
